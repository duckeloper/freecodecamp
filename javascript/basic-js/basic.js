...
// const myStr = "I am a \"double quoted\" string inside \"double quotes\"."; // 문자열에 따옴표 넣고 싶으면 백슬래시
...
/* function checkObj(obj, checkProp) {
  // Only change code below this line
  console.log("prop: " + checkProp);
  console.log("property t/f: " + obj.hasOwnProperty(checkProp))
